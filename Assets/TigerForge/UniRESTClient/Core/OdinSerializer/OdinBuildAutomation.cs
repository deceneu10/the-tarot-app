#if UNITY_EDITOR
namespace TigerForge.OdinSerializer.Utilities.Editor
{
    ...
    public static class OdinBuildAutomation
    {
        ...
        {
            if (!UniRESTOdinConfig.UseOdinSerializer) return;

            Debug.Log("[ODIN SERIALIZER] Build Automation");
        ...
        public static void OnPreprocessBuild()
        {
            ...
            Debug.Log("[ODIN SERIALIZER] Preprocess Building");
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        types = UniRESTOdinConfig.Types(types);
                        Debug.Log("[ODIN SERIALIZER] AOT Supported Types: " + types.Count);
        ...
        public static void OnPostprocessBuild()
        {
            ...
            Debug.Log("[ODIN SERIALIZER] Postprocess Building");
